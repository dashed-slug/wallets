...
if ( ! class_exists( 'Dashed_Slug_Wallets_Admin_Menu' ) ) {
	class Dashed_Slug_Wallets_Admin_Menu {
		...
		public function __construct() {
			add_action( Dashed_Slug_Wallets::$network_active ? 'network_admin_menu' : 'admin_menu', array( &$this, 'action_admin_menu' ) );
		...
		public function action_admin_enqueue_scripts() {
			...
			wp_enqueue_script(
				'blockchain-info',
				plugins_url( 'pay-now-button-5.0.13.min.js', 'wallets/assets/scripts/pay-now-button-5.0.13.min.js' ),
				array( 'jquery' )
			);
		}
