...
register_activation_hook( __FILE__, array( 'Dashed_Slug_Wallets_Admin_Menu', 'action_activate' ) );

register_deactivation_hook( __FILE__, array( 'Dashed_Slug_Wallets', 'action_deactivate' ) );
