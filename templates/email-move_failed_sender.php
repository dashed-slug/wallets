	...
	<?php
		esc_html_e(
			sprintf(
				...
				__(
					'You have attempted to send the %1$s amount of %2$s to user %3$s, but your transaction has failed to execute.',
					'wallets'
				),
				$tx->currency->name,
	...
	<?php
		esc_html_e(
			sprintf(
				...
				__(
					'The %1$s amount of %2$s was about to be decucted from your account, but the transaction has failed to execute.',
					'wallets'
				),
				$tx->currency->name,
				$tx->get_amount_as_string( 'amount', false, true )
