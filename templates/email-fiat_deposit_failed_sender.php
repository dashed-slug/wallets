 ...
 *
 * The deposit is now marked as failed (cancelled state/draft post status and non-empty wallets_error post meta).
 *
...
<?php
	esc_html_e(
		sprintf(
			...
			__(
				'You had requested a %1$s deposit of %2$s from your bank account.',
				'wallets'
			),
			$tx->currency->name,
...
<p><?php esc_html_e( 'An admin has marked your deposit as "failed". Please check the error message below for details.', 'wallets' ); ?></p>
