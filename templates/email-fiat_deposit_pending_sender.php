 ...
 * Explains that the user will need to wait for an admin to confirm the withdrawal.
 *
...
<?php
	esc_html_e(
		sprintf(
			...
			__(
				'You have requested a %1$s deposit of %2$s from your bank account. We have now marked your deposit as "pending".',
				'wallets'
			),
			$tx->currency->name,
...
<p><?php esc_html_e( 'An admin will process your withdrawal soon. You will receive another notification.', 'wallets' ); ?></p>
