...
/**
 * Email sent to the admins, when a fiat deposit is marked as failed.
 *
...
<p><?php esc_html_e( 'The deposit is now marked "failed".', 'wallets' ); ?></p>
<p><?php esc_html_e( 'An admin can change this. To do so, please visit:', 'wallets' ); ?></p>
