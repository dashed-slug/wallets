...
/**
 * Email sent to the recipient of a deposit that is now failed (failed state/draft post status and non-empty wallets_error post meta).
 *
...
<?php
	esc_html_e(
		sprintf(
			...
			__(
				'You were about to receive a %1$s deposit of %2$s from %3$s.',
				'wallets'
			),
			$tx->currency->name,
...
<p><?php esc_html_e( 'There was an error with your deposit. Please see the error message below for details.', 'wallets' ); ?></p>
