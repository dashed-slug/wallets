...
/**
 * Email sent to the sender of a withdrawal that is now executed (done state/published post status).
 *
...
<?php
	esc_html_e(
		sprintf(
			...
			__(
				'Your %1$s withdrawal of %2$s to address %3$s has been executed.',
				'wallets'
			),
			$tx->currency->name,
